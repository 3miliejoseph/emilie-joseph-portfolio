...
export const projects = [
  ...
  },
  {
    ...
    previewVideo: "https://raw.githubusercontent.com/3miliejoseph/emilie-joseph-portfolio/main/public/Static.mp4",
    caseStudy: (
      <>
              ...
              <AnimatePresence>
                {showMusicTooltip && (
                  <motion.div
                    ...
                    className="absolute -top-1 left-1/2 -translate-x-1/2 px-3 py-1.5 bg-foreground text-background text-xs rounded-md whitespace-nowrap pointer-events-none z-50"
                  >
                    Music
